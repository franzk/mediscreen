package com.abernathy.mediscreen.massessment.repository;
...
public class AssessmentRepository {
    ...
    /**
     *
     * @return l'aggregation renvoie un document du type [{_id: "", total: 1}]
     */
    public AggregateIterable<Document> getTriggersCountAggregationQueryResult(Integer patientId, String triggersRegex) {
